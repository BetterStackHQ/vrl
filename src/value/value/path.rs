...
mod at_path_tests {
    ...
    fn test_object() {
        ...
        let bar_value = Value::Object(IndexMap::from([("baz".into(), value.clone())]));
        let foo_value = Value::Object(IndexMap::from([("bar".into(), bar_value)]));

        let object = Value::Object(IndexMap::from([("foo".into(), foo_value)]));
    ...
    fn test_complex() {
        ...
        let foo_value = Value::Object(IndexMap::from([("baz".into(), baz_value)]));

        let object = Value::Array(vec![
            Value::Null,
            Value::Null,
            Value::Object(IndexMap::from([("foo".into(), foo_value)])),
        ]);
